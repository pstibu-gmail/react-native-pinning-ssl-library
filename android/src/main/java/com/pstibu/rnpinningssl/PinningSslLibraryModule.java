...
public class PinningSslLibraryModule extends ReactContextBaseJavaModule {
    ...
    public PinningSslLibraryModule(ReactApplicationContext reactContext) {
        super(reactContext);
